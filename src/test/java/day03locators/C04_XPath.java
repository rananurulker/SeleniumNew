...
driver.get("https://www.testotomasyonu.com");
        ...
        List<WebElement>urunIsimElemanlariList=driver.findElements(By.xpath("//a[@class= 'prod-title mb-3 ']"));

        if (urunIsimElemanlariList.size()>0){
        ...
        System.out.println(ReusableMethods.getStringList(urunIsimElemanlariList));
